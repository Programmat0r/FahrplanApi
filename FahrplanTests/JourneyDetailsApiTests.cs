...
namespace Fahrplan.Tests
{
    ...
    public class JourneyDetailsApiTests
    {
        ...
        {
            JourneyDetailsApi journeyDetailsApi = new JourneyDetailsApi("156462%252F58512%252F820424%252F358058%252F80%253fstation_evaId%253D8000105", new Authentication(this.Token));
            journeyDetailsApi.TestMode = true;
            var journeyDetails = journeyDetailsApi.Get();
           

            Assert.AreEqual(journeyDetails.Length, 24);
        }
    }
}